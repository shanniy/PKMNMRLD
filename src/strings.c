...
const u8 gText_TextMode[] = _("TEXT MODE");
...
const u8 gText_RunTypeNormal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NORMAL");
const u8 gText_RunTypeAuto[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}AUTO");
const u8 gText_TextTypeNormal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NORMAL");
const u8 gText_TextTypeAuto[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}AUTO");
