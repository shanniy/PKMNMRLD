...
extern const u8 gText_RunTypeNormal[];
extern const u8 gText_RunTypeAuto[];
extern const u8 gText_TextTypeNormal[];
extern const u8 gText_TextTypeAuto[];
...
extern const u8 gText_TextMode[];
